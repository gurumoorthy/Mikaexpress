...
package com.gurumoorthy.mikaexpress.util;
...
import com.gurumoorthy.mikaexpress.ui.home.HomeFragment;
import com.gurumoorthy.mikaexpress.view.fragment.ContactUsFragment;
import com.gurumoorthy.mikaexpress.view.fragment.MyCartFragment;
import com.gurumoorthy.mikaexpress.view.fragment.ProductOverviewFragment;
import com.gurumoorthy.mikaexpress.view.fragment.SettingsFragment;
...
//	}
    ...
    public static void alertDialogFinish(int value, final Activity activity) {
...
//                });
    ...
    public static void alertDialog(int value, final Activity activity) {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(activity);
        builder1.setTitle("Alert");
        builder1.setMessage(value);
        builder1.setCancelable(true);
